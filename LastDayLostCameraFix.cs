...
namespace DisableDisappearanceItemsInBell;
...
[ContentWarningPlugin("DisableDisappearanceItemsInBell", "0.1", vanillaCompatible: false)]
public class DisableDisappearanceItemsInBell
{
    static DisableDisappearanceItemsInBell()
    {
        ...
        Debug.Log("Hello from DisableDisappearanceItemsInBell! This is called on plugin load");
